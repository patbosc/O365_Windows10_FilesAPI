    ...
    public class MyFilesModel : INotifyPropertyChanged
    {
        ...
        public string Icon
        {
            get
            {
                ...
                if (this.Name.EndsWith(".docx", StringComparison.CurrentCultureIgnoreCase))
                    return "ms-appx://assets/app/docx.png";
                if (this.Name.EndsWith(".pdf", StringComparison.CurrentCultureIgnoreCase))
                    return "ms-appx://assets/app/pdf.png";
                else
                    return "ms-appx:///assets/app/gif.png";
            }
        }
